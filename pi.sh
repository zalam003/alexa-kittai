...
CMAKE_PLATFORM_SPECIFIC=(-DKITTAI_KEY_WORD_DETECTOR=ON \
    ...
    -DCMAKE_INSTALL_PREFIX="$INSTALL_BASE/sdk-install \
...
generate_start_script() {
  ...
  PA_ALSA_PLUGHW=1 ./SampleApp "$OUTPUT_CONFIG_FILE" "$THIRD_PARTY_PATH/snowboy/resources" DEBUG9
EOF
}
